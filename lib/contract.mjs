...
// branch in lib/cli.mjs's runWait (the bare error shape, not this one) --
...
// `seq` is populated by R4 (lib/cli.mjs, sourced from appendDeltaLog's
...
// DELTA_CLASSES, and the switch in lib/cli.mjs has a case for every one of
