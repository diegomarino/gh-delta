...
// `firstObserved` (TODO(R6): populated by R6) and `seq` (TODO(R4): populated
// by R4, sourced from appendDeltaLog's {fromSeq, toSeq} return value) are
// reserved now so the schemas regenerate exactly once for this epic; neither
// is set by any code yet.
