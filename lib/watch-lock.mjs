...
// purely so lib/watch.mjs and lib/cli/detector.mjs can share the mark/lock mechanics
 ...
 * codebase, not assumed: `watch add`/`rm` (lib/cli/commands/watch.mjs's runWatch) only
 ...
 * lib/cli/detector.mjs's durable-log write (`appendDeltaLog`'s `onProgress`) extends
