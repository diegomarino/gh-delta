...
const HELP_SPECS = {
  'gh-delta': {
    ...
    output: {
      ...
      description:
        'JSON output contains schemaVersion, baseline, repo, monitorId, entities, at, deltas, and summary fields; error output is schemaVersion, error, kind, at, and optional repo and monitorId. Text output contains an operator heartbeat and suggested actions.',
    },
