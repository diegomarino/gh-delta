  ...
  'gh-delta': {
    ...
    options: [
      ...
      OPTION_STATE_DIR,
      {
        ...
        required: false,
        description:
          'Local watch-list directory. With 0-10 PR-only entries, automatically makes one targeted GraphQL request (zero for empty) and uses a separate watch snapshot; issue entries or >10 entries retain broad fetching. Mutually exclusive with --number.',
      },
      {
        name: '--number',
        valueName: 'numbers',
