...
/**
 * Parse the selected output format from argv, defaulting to JSON.
 *
 * Supports `--format text|json` and `--format=<value>`.
 */
...
/**
 * Ensure text output is never emitted without detail lines.
 *
 * When format is text, detail mode improves triage readability by including
 * delta lines in the report payload; JSON mode keeps raw structured output.
 */
