 ...
 * (see lib/lock.mjs's `extendLockDeadline` and lib/cli/detector.mjs's wiring) rides on:
 ...
 * see `walk`'s doc comment; lib/cli/detector.mjs uses this to extend the run's lock
