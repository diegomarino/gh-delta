...
/**
 * Registry entry path for one monitor. The key is a hash of the resolved
 ...
 */
export function registryEntryPath(registryDir, stateFile) {
  const key = createHash('sha256').update(resolve(stateFile)).digest('hex').slice(0, 16);
