...
// compared and never hashed into the delta id (see lib/snapshot.mjs).
...
function classifyPr(oldFp, fp) {
  ...
  if (oldFp.head !== fp.head) c.push('head-changed', 'updated');
  ...
  if (oldFp.base !== fp.base) c.push('base-changed');
