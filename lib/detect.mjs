...
// Compared fields added after schema v1 shipped. A snapshot written before one of
// these existed lacks the key, and its first appearance is not a real change.
// (Issue snapshots have always carried `labels`, so the entry is inert there.)
const ADDITIVE_COMPARED_FIELDS = [
  'mergeStateStatus',
  'base',
  'labels',
  'assignees',
