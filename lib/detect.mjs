 ...
 *  1. Fetched objects -- `new` (no prior fp), `reappeared` (prior fp was
 *     `missing`, optionally plus a specific class if it also changed), or a
 *     normal change classified by `classifyFn` (falling back to `updated` for
 *     updatedAt/head-only churn).
